        ...
        <div class="col-8">
            ...
            <form action="/komik/update/<?= $komik['id_komik']; ?>" method="post">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control <?= ($validation->hasError('sampul')) ? 'is-invalid' : ''; ?>" id="sampul" name="sampul" value="<?= $komik['sampul']; ?>">
                        <div id="validationServer03Feedback" class="invalid-feedback">
                ...
                <div class="mb-3 row">
                    <div class="col-sm-10">
                        ...
                        <a href="/komik/<?= $komik['slug']; ?>" class="btn btn-danger">Batal</a>
                    </div>
                </div>
            </form>
        </div>
